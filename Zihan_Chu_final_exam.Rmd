...
data_dictionary <- data_dictionary <- read_excel(file.choose("HUD T03 - 05b Analysis File - Data Dictionary.xlsx"))
```
...
homelessness_data_analysis <- homelessness_data_analysis %>%
  mutate(log_homelessness_rate = log(homelessness_rate + ifelse(zero_count > 0, 0.0001, 0)))
